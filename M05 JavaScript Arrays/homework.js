...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
  var elementoEncontrado = array.includes(elemento);
...
function agregarNumeros(arrayOfNums) {
  ...
  // Tu código:
  var suma = arrayOfNums.reduce((acc, item) => {
    return (acc = acc + item);
  });
  return suma;
}
...
function mayorACien(array) {
  ...
  // Tu código:
  var nuevoArray = array.filter((e) => e > 100);
  return nuevoArray;
}
